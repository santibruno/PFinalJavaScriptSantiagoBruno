...
class Producto {
    constructor(nombre, id, valor, color,stock){
...
let productos=[]
let carrito=[]
productos.push(new Producto ("Remera con estampa","1", "500","negra","9"),new Producto ("Remera lisa", "2", "300","blanca","5"),new Producto ("Jean skinny", "3", "1200","azul", "2"),new Producto ("Buzo hoodie", "4", "1500","violeta","10"),new Producto ("Pantalon babucha", "5", "500","Blanco","6"),new Producto ("Piluso","6" , "50","negro","9"),new Producto ("Campera jean","7", "2000","Jean","2"))
